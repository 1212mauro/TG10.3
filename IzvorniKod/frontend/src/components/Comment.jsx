  ...
  return (
    <div className="px-4 py-2 bg-gray-100 rounded-lg mb-2">
      <div class="flex items-center justify-between h-12 bg-gray-100">
        ...
        {canDelete && (<button onClick={() => deleteComment(comment.messageId)} class="bg-red-500 text-white text-sm px-3 py-1.5 rounded hover:bg-red-700 transition duration-300">
          Delete
        </button>)}
      </div>
